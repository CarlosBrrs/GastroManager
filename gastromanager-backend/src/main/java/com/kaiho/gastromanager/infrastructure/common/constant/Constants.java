...
public abstract class Constants {
    ...
    public static final String RECIPES_CONTROLLER = "/recipes";
    ...
    public static final String MENUS_CONTROLLER = "/menus";
    public static final String SUBMENUS_CONTROLLER = "/submenus";
    ...
    public static final String RESTAURANTS_CONTROLLER = "/restaurants";
    ...
    public static final String REPORT_SALES_CONTROLLER = "/reports/sales";
    ...
    public static final String MENU_UUID_PARAMETER = "/{menuUuid}";
    public static final String SUBMENU_UUID_PARAMETER = "/{submenuUuid}";
    public static final String PRODUCT_ITEM_UUID_PARAMETER = "/{productItemUuid}";
    public static final String CASH_REGISTER_SESSION_UUID_PARAMETER = "/{sessionUuid}";
    public static final String PRODUCT_UUID_PARAMETER = "/{productUuid}";
    public static final String ORDER_UUID_PARAMETER = "/{orderUuid}";
    public static final String RESTAURANT_UUID_PARAMETER = "/{restaurantUuid}";
    public static final String CASH_REGISTER_UUID_PARAMETER = "/{cashRegisterUuid}";
