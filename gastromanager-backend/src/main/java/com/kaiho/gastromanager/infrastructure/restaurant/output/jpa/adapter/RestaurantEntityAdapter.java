...
import com.kaiho.gastromanager.infrastructure.restaurant.output.jpa.repository.RestaurantConfigEntityRepository;
...
public class RestaurantEntityAdapter implements RestaurantPersistencePort {
    ...
    public RestaurantConfig createRestaurantConfig(RestaurantConfig restaurantConfig) {
        ...
        RestaurantConfigEntity restaurantConfigEntity = restaurantEntityMapper.toEntity(restaurantConfig);
    ...
    public RestaurantConfig getRestaurantConfigByRestaurantUuid(UUID currentRestaurant) {
        return restaurantEntityMapper.toDomain(restaurantConfigEntityRepository.findByRestaurantUuid(currentRestaurant).orElseThrow(() -> new IllegalArgumentException("no cofigs for the restaurant: " + currentRestaurant)));
    }
