...
const moduleFilters: Record<string, FilterConfig[]> = {
  ...
  products: [
    {type: 'search', placeholder: 'Buscar producto...', key: 'name'},
    {
      ...
      label: 'Categoría',
      key: 'category',
      options: ['Entradas', 'Platos principales', 'Postres', 'Bebidas']
    },
  ...
  'reports/sales': [
    ...
    {type: 'date', label: 'Fecha hasta', key: 'dateTo'},
    {
      ...
      label: 'Cajas',
      key: 'cashRegister',
      options: ['Caja Principal', 'Caja Secundaria', 'Caja Express', 'Caja Drive-Thru']
    },
  ...
  'reports/inventory': [
    {type: 'search', placeholder: 'Buscar producto...', key: 'productName'},
    {
      ...
      label: 'Categoría',
      key: 'category',
      options: ['Carnes', 'Vegetales', 'Lácteos', 'Condimentos', 'Bebidas']
    },
    {
      type: 'select',
      label: 'Estado stock',
      key: 'stockStatus',
      options: ['Stock alto', 'Stock medio', 'Stock bajo', 'Sin stock']
    },
    {type: 'date', label: 'Fecha desde', key: 'dateFrom'},
    {type: 'date', label: 'Fecha hasta', key: 'dateTo'},
  ...
  'reports/performance': [
    ...
    {type: 'select', label: 'Período', key: 'period', options: ['Hoy', 'Esta semana', 'Este mes', 'Trimestre']},
    {
      ...
      label: 'Métrica',
      key: 'metric',
      options: ['Tiempo promedio', 'Satisfacción', 'Eficiencia', 'Productividad']
    },
    {
      type: 'select',
      label: 'Empleado',
      key: 'employee',
      options: ['Todos', 'Juan Pérez', 'María García', 'Carlos López']
    },
